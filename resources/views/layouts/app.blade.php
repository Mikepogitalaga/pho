            ...
            <nav class="sidebar-nav">
                ...
                <div class="sidebar-nav-group">
                    ...
                    <a href="{{ route('reports.master-file') }}" class="sidebar-link {{ request()->routeIs('reports.master-file*') ? 'active' : '' }}">
                        <span class="sidebar-link-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16v16H4z"/><path d="M8 8h8M8 12h8M8 16h5"/></svg>
                        </span>
                        <span class="sidebar-link-text">Master File</span>
                    </a>
                    <a href="{{ route('reports.liquidation') }}" class="sidebar-link {{ request()->routeIs('reports.liquidation*') ? 'active' : '' }}">
                        <span class="sidebar-link-icon" aria-hidden="true">
                ...
                @if(auth()->user()?->isAdmin())
                    <div class="sidebar-nav-group">
                        ...
                        <a href="{{ route('facilities.index') }}" class="sidebar-link {{ request()->routeIs('facilities.*') ? 'active' : '' }}">
                            <span class="sidebar-link-icon" aria-hidden="true">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 21h18M5 21V7l8-4 8 4v14M9 21V12h6v9"/></svg>
                            </span>
                            <span class="sidebar-link-text">Facilities</span>
                        </a>
