...
@section('content')
    ...
    <section class="dashboard-kpi-grid" role="region" aria-label="GSO supply chain metrics">
        ...
        <article class="kpi-card kpi-card--teal">
            ...
            <p class="kpi-card-foot">All GSO receiving records</p>
        </article>
        ...
        <article class="kpi-card kpi-card--green">
            ...
            <p class="kpi-card-foot">Cumulative qty from GSO</p>
        </article>
    ...
    <div class="dashboard-analytics-row">
        <section class="section-card chart-card" aria-label="GSO supply movement chart">
            <div class="section-header compact">
                <div>
                    <h3 class="section-card-title">Supply Movement</h3>
                    <p class="page-description">Monthly GSO received vs released (last 6 months).</p>
                </div>
                <span class="chart-legend" aria-hidden="true">
                    <span class="chart-legend-item"><span class="chart-legend-swatch chart-legend-swatch--received" style="background: #d97706;"></span> Received</span>
            ...
            <div class="chart-container">
                <canvas id="gsoSupplyMovementChart" role="img" aria-label="Bar chart: GSO received vs released"></canvas>
            </div>
        </section>

        <section class="section-card chart-card" aria-label="Top GSO suppliers chart">
            <div class="section-header compact">
                <div>
                    <h3 class="section-card-title">Top GSO Suppliers</h3>
                    <p class="page-description">Receiving volume by supplier (last 6 months).</p>
                </div>
            </div>
            <div class="chart-container">
                <canvas id="gsoSupplierShareChart" role="img" aria-label="Doughnut chart showing GSO supplier receiving distribution"></canvas>
            </div>
        </section>
    </div>
        ...
        <section class="section-card chart-card" aria-label="Monthly receivings trend">
            <div class="section-header compact">
                <div>
                    ...
                    <p class="page-description">GSO receivings per month (last 6 months).</p>
                </div>
            </div>
            <div class="chart-container">
                <canvas id="gsoMonthlyChart" role="img" aria-label="Line chart: monthly GSO receivings"></canvas>
            </div>
        </section>
        ...
        <section class="section-card chart-card" aria-label="Release trend">
            <div class="section-header compact">
                <div>
                    ...
                    <p class="page-description">Monthly release quantity from GSO-sourced items.</p>
                </div>
            </div>
            <div class="chart-container">
                <canvas id="gsoReleaseTrendChart" role="img" aria-label="Line chart: GSO release trend"></canvas>
            </div>
        </section>
    </div>
    ...
    <div class="dashboard-content-grid">
        <section class="section-card" aria-label="Recent GSO receivings">
            <div class="section-header compact">
                <div>
                    <h3 class="section-card-title">Recently Received</h3>
                    <p class="page-description">Latest supply receipts from GSO suppliers.</p>
                </div>
            ...
            @if($recentReceived->isEmpty())
                <div class="empty-state" role="status">
                    ...
                    <div style="margin-top: 0.35rem;">Receipts from GSO suppliers appear here.</div>
                </div>
            @else
        ...
        <section class="section-card" aria-label="Recent releases">
            <div class="section-header compact">
                <div>
                    ...
                    <p class="page-description">Latest releases of GSO-sourced items.</p>
                </div>
            ...
            @if($recentReleases->isEmpty())
                <div class="empty-state" role="status">
                    ...
                    <div style="margin-top: 0.35rem;">Releases of GSO items appear here.</div>
                </div>
            @else
                <ul class="activity-list">
...
document.addEventListener('DOMContentLoaded', function () {
    var movementCanvas = document.getElementById('gsoSupplyMovementChart');
    var shareCanvas = document.getElementById('gsoSupplierShareChart');
    var monthlyCanvas = document.getElementById('gsoMonthlyChart');
    var trendCanvas = document.getElementById('gsoReleaseTrendChart');
    ...
    if (shareCanvas) {
        var shareColors = ['#d97706', '#3b82f6', '#8b5cf6', '#16a34a', '#dc2626', '#06b6d4'];
