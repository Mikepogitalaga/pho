...
@section('title', $supplier->company_name . ' — GSO Dashboard')
@section('pageHeading', $supplier->company_name . ' — GSO Dashboard')
@section('pageSubheading', 'Supply chain oversight — from GSO receiving to distribution release.')
...
@section('content')
    ...
    <div class="dashboard-analytics-row">
        ...
        <section class="section-card chart-card" aria-label="Monthly release trend chart">
            ...
            <div class="chart-container">
                <canvas id="gsoReleaseTrendChart" role="img" aria-label="Line chart: release trend"></canvas>
            </div>
        </section>
    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Monthly GSO Received vs Released Bar Chart
