...
@section('pageHeading', 'Edit Supplier')
@section('pageSubheading', 'Update supplier information.')

@section('content')
    <section class="card">
        <form action="{{ route('suppliers.update', $supplier) }}" method="POST" class="stack">
