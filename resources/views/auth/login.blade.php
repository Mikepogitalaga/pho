...
<head>
    ...
    <title>Sign In — PHO Supply Office</title>
...
<body>
    ...
    <div class="auth-hero">
        <div class="auth-hero-content">
            ...
            <h1>Manage your supply inventory with ease.</h1>
            <p>Track incoming and outgoing stock, manage suppliers, and generate reports — all in one place.</p>
    ...
    <div class="auth-panel">
        <div class="auth-panel-inner">
            ...
            <p class="auth-subheading">Sign in to access the inventory dashboard.</p>
