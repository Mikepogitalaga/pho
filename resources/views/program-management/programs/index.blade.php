...
@section('pageSubheading', 'List of all programs')
...
<div class="page-container">
    <div class="page-section">
        <div class="page-section-header d-flex justify-content-between align-items-center">
            <div>
                <h2 class="page-section-title">Programs</h2>
                <p class="page-section-description">Manage all programs and their assigned coordinators</p>
            </div>
        ...
        <div class="page-section-content">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form method="GET" action="{{ route('program-management.programs.index') }}" class="row g-3">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="search" name="search" value="{{ request('search') }}" placeholder="Search programs...">
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <a href="{{ route('program-management.programs.index') }}" class="btn btn-secondary w-100">Clear</a>
                        </div>
                    </form>
                </div>
            </div>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-4">
                                            <div class="text-muted">No programs found.</div>
                                            <a href="{{ route('program-management.programs.create') }}" class="btn btn-primary mt-2">Create a new program</a>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
