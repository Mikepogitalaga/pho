...
@section('content')
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; gap:1rem; flex-wrap:wrap; margin-bottom:1.25rem;">
        <div>
            <h1 style="margin:0; font-size:1.5rem; font-weight:800; letter-spacing:-0.02em;">Items</h1>
            <p style="margin:0.25rem 0 0; color:var(--text-muted); font-size:0.92rem;">Master inventory list &mdash; stock managed through Receiving &amp; Release only.</p>
        </div>
